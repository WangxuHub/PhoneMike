...
<body style="padding: 10px;">
    ...
    <div style="margin: 5px 0px;">
        Address:
&nbsp;<div>
    <input id="address" type="text" value="<%=PhoneMike.WebSocketServer.WebSocketInfo.WebSocketAdress %>" style="width: 400px;" />
        </div>
    </div>
    <div style="margin: 5px 0px;">
        Name:
		<div>
            <input id="name" type="text" value="Byron" style="width: 400px;" />
        </div>
    </div>
    <div>
    ...
    <div id="message" style="border: solid 1px #333; padding: 4px; width: 80%; overflow: auto; background-color: #404040; height: 300px; margin-bottom: 8px; font-size: 14px;">
    </div>
